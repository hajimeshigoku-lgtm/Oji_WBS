    ...
    <div style={s.wrap}>
      ...
      {adding && (
        <div style={{...s.card,marginBottom:14,background:"#f8faff",borderColor:"#bfdbfe"}}>
          ...
          <input placeholder="タスクの説明（何をするタスクか）" value={newT.desc} onChange={e=>setNewT(p=>({...p,desc:e.target.value}))} style={{...s.inp,marginBottom:8}}/>
      ...
      {!editing ? (
        <div style={{display:"flex",alignItems:"flex-start",gap:8}}>
          ...
          <div style={{flex:1,minWidth:0}}>
            ...
            {task.desc&&<div style={{fontSize:12,color:"#6b7280",lineHeight:1.6}}>{task.desc}</div>}
          </div>
        ...
        <div>
          ...
          <input value={task.desc} onChange={e=>upd(task.id,"desc",e.target.value)} placeholder="説明" style={{...s.inp,marginBottom:6}}/>
